...
train_pipeline = [
    ...
    dict(
        ...
        max_lanes=16,
        keys=['img'],
        meta_keys=['filename', 'sub_img_name', 'ori_shape', 'test_shape', 'img_shape', 'img_norm_cfg',
            'ori_shape', 'img_shape', 'gt_points', 'gt_masks', 'lanes'],
        ),
    ]
...
val_pipeline = [
    ...
    dict(
        ...
        max_lanes=16,
        keys=['img'],
        meta_keys=['filename', 'sub_img_name', 'ori_shape', 'img_shape', 'img_norm_cfg',
            'ori_shape', 'img_shape', 'gt_points', 'crop_shape', 'crop_offset'],
        ),
]
